...
function displaySubcategories(category) {
  ...
  const subcategoriesMap = {
    Sac: ["Sac à mains", "Sacs à dos", "Bandoulières"],
    Chapeau: ["Béret", "Casquettes", "Bonnets"],
    Lunettes: ["Aviateur", "Wayfarer", "Cat-eye"]
  };
...
function applyFilters(category = "", subcategory = "") {
  let filteredProducts = products.filter(product => product.menu === "Accessoires");
